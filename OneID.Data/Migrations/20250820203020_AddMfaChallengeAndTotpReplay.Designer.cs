...
namespace OneID.Data.Migrations
{
    ...
    [Migration("20250820203020_AddMfaChallengeAndTotpReplay")]
    partial class AddMfaChallengeAndTotpReplay
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OneID.Application.Messaging.Sagas.Contracts.AccountSagaState", b =>
                {
                    ...
                    b.Property<bool>("KeycloakCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false);
                    ...
                    b.Property<bool>("LoginAllocated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false);
            ...
            modelBuilder.Entity("OneID.Domain.Entities.JobTitleContext.JobTitle", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
                    ...
                    b.HasIndex("Name")
                        .HasDatabaseName("idx_job_title_name");

                    b.ToTable("tb_oneid_job_titles", (string)null);
                });
            ...
            modelBuilder.Entity("OneID.Domain.Entities.Logins.IdempotencyEntry", b =>
                {
                    ...
                    b.ToTable("tb_oneid_idempotency", (string)null);
                });

            modelBuilder.Entity("OneID.Domain.Entities.Logins.LoginReservation", b =>
                {
                    b.Property<string>("Login")
                        .HasMaxLength(120)
                        .HasColumnType("character varying(120)");
                    ...
                    b.ToTable("tb_oneid_login_reservations", (string)null);
                });

            modelBuilder.Entity("OneID.Domain.Entities.Logins.MfaChallengeEntity", b =>
                {
                    b.Property<string>("Jti")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("OneID.Domain.Entities.Tokens.OneTimeToken", b =>
                {
                    b.Property<string>("Jti")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");
                    ...
                    b.ToTable("tb_oneid_tokens", (string)null);
                });

            modelBuilder.Entity("OneID.Domain.Entities.TotpOptions.TotpCodeUseEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
                    ...
                    b.ToTable("tb_oneid_totp_code_used_window", (string)null);
                });
            ...
            modelBuilder.Entity("OneID.Domain.Entities.UserContext.UserAccount", b =>
                {
                    ...
                    b.HasIndex("LastName")
                        .HasDatabaseName("idx_user_account_lastname");
                    ...
                    b.OwnsOne("OneID.Application.DTOs.Admission.KeycloakPayload", "KeycloakData", b1 =>
                        {
                            ...
                            b1.Property<Guid>("KeycloakUserId")
                                .HasColumnType("uuid");
            ...
            modelBuilder.Entity("OneID.Domain.Entities.UserContext.UserAccount", b =>
                {
                    b.HasOne("OneID.Domain.Entities.DepartmentContext.Department", null)
                        .WithMany()
                        .HasForeignKey("DepartmentId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("OneID.Domain.Entities.JobTitleContext.JobTitle", null)
                        .WithMany()
