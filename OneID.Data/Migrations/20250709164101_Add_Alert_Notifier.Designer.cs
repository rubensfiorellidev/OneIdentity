...
namespace OneID.Data.Migrations
{
    ...
    [Migration("20250709164101_Add_Alert_Notifier")]
    partial class Add_Alert_Notifier
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OneID.Domain.Entities.AlertsContext.AlertSettings", b =>
                {
                    ...
                    b.Property<List<string>>("CriticalRecipients")
                        .IsRequired()
                        .HasColumnType("jsonb");

                    b.Property<List<string>>("InfoRecipients")
                        .IsRequired()
                        .HasColumnType("jsonb");

                    b.Property<List<string>>("WarningRecipients")
                        .IsRequired()
                        .HasColumnType("jsonb");
